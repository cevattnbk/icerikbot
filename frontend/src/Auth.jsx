      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-8">
          ...
          <button type="button" onClick={async () => {
            ...
            className="w-full py-3 rounded-lg bg-white hover:bg-slate-100 text-slate-800 font-semibold text-sm transition-all flex items-center justify-center gap-2 border border-slate-300">
