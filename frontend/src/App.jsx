...
{ id: "pro", name: "Pro", price: "699₺", credits: "500 analiz", highlight: true, features: ["500 analiz/ay", "100 görsel (Vision) analiz", "Sınırsız toplu analiz", "API erişimi", "Banner aracı", "XML/Excel toplu içerik", "Kar/Zarar analizi", "7/24 destek"] },
{ id: "ajans", name: "Ajans", price: "1.499₺", credits: "1000 analiz", features: ["1000 analiz/ay", "300 görsel (Vision) analiz", "API erişimi", "Toplu banner", "XML/Excel toplu içerik", "Kar/Zarar analizi", "White label", "Özel destek"] },
                  ].map(p => (
