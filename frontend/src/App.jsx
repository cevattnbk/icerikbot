...
const [bulkProgress, setBulkProgress] = useState(0);
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const res = await fetch("https://https://icerikbot-production.up.railway.app/api/analyze", {
        method: "POST",
 ...
 const handleBulkAnalyze = async () => {
    ...
    setBulkProgress(0);
    try {
      const res = await fetch("https://https://icerikbot-production.up.railway.apphttps://icerikbot-production.up.railway.app/api/analyze-bulk", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
