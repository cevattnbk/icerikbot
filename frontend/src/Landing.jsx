...
<p className="text-sm font-medium text-slate-500 mt-3">✓ 3 ücretsiz analiz hakkı &nbsp;•&nbsp; ✓ Kredi kartı gerekmez &nbsp;•&nbsp; ✓ 30 saniyede kayıt</p>
  ...
  <div className="flex items-center gap-2">
    ...
    <div>
      ...
      <p className="text-sm text-slate-500">Ürününüzün boyutlarını girin, kargo ücretine esas ağırlığı anında görün.</p>
    </div>
  </div>
  <span className={`text-slate-400 text-xl transition-transform flex-shrink-0 ml-2 ${desiOpen ? "rotate-180" : ""}`}>⌄</span>
</button>
